...
const ContactUs = () => {
    return (
        <div className={"w-full min-h-screen"}>
            ...
            <Layout>
                <h2 className={"text-5xl mt-12 mb-4 text-transparent font-semibold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text"}>Contact
                    us</h2>
                ...
                <div
                    className={"grid grid-cols-1 max-w-[95%] w-full mx-auto relative z-50 -mt-16 gap-5 lg:grid-cols-3"}>
                    <div
                        className="shadow-lg hover:-translate-y-8 bg-white lg:h-[300px] duration-100 ease-out cursor-pointer transition shadow-gray-300 rounded-lg  p-10">
