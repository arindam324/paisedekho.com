...
const DashBoard = () => {
    ...
    return (
        <div className="w-full min-h-screen">
            <Layout>
                <h2 className={"w-full  text-2xl    mt-12"}> Welcome! <span
                    className="font-semibold">{data?.user?.name}</span></h2>
                <div className="my-12 flex w-full space-x-12">
                    <aside
                        className=" hidden lg:block max-w-[300px] w-full bg-white shadow-xl transition-all	 rounded-lg px-10 py-8 ">
                    ...
                    <div className={"max-w-xs  w-full"}>
                      <div className={"p-5  ring-2 ring-pink-500 ring-inset min-h-[200px] rounded-md shadow-xl"}>
